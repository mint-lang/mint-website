CodeMirror.defineSimpleMode("mint", {
  start: [
    ...
    {regex: /(?:type|let|global|component|store|fun|get)\b/, token: "keyword"},
    {regex: /(?:state|routes|const|module|decode|defer)\b/, token: "keyword"},
    {regex: /(?:property|connect|exposing|if|for|await)\b/, token: "keyword"},
    {regex: /(?:next|where|case|or|return)\b/, token: "keyword"},
    {regex: /(?:@highlight|@svg|@asset|@inline)\b/, token: "keyword"},
